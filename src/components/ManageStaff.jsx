...
const ManageStaff = () => {
    ...
    return (
        <div className="flex-1 mt-10 py-4 px-8">
                ...
                <table className="border-solid w-full">
                    <thead className="border-t-[1px] border-b-[1px]">
                        <tr className="text-left font-normal text-sm">
                            <th className="w-[150px]">Mã nhân viên</th>
                            <th className="w-[150px]">Họ tên</th>
                            <th className="w-[200px]">Vị trí</th>
                            <th className="w-[150px]">Hoạt động</th>
                            <th className="w-[150px]">Ngày tham gia</th>
                    ...
                    <tbody>
                        {
                            staffs.map((staff) => (
                                <tr className="h-[40px] text-sm font-medium" key={staff._id}>
                                    ...
                                    <td>{staff.active ? <MdCheckCircle className="text-green-700 ml-7 text-xl" /> : <MdCancel className="text-red-700 ml-7 text-xl" />}</td>
                                    <td>{staff.createdAt.split('T')[0]}</td>
                                    <td>
            ...
            {
                modal === 'add' &&   <Modal show={show} className="bg-gray-300">
                                ...
                                <div className="flex flex-col mb-4">
                                    ...
                                    <select className="text-sm outline-none" name="role" onChange={handleOnChange}>
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <button className="bg-red-700 font-semibold text-sm text-white px-4" onClick={handleAddStaff}>Thêm</button>
                                    </div>
                              </Modal>}
            {
